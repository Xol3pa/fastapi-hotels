...
async def setup_database(check_test_mode):
    ...
    validate_rooms_facilities = [
        RoomFacilityCreate.model_validate(r_f) for r_f in rooms_facilities_data
    ]
    validate_facilities = [
        FacilityCreate.model_validate(facility) for facility in facilities_data
    ]
